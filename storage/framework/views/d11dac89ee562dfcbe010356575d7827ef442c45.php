...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="<?php echo e(url('lotes')); ?>">Conjuntos</a>
			</li>
			<li>
				<a href="<?php echo e(url('lotes/pecas')); ?>">Peças</a>
			</li>
		</ul>
	</div>
	...
	<nav class="navbar navbar-static-top navbar-inverse" role="navigation">
		...
		<?php echo e(Form::open(['url'=>url('/lotes'),  'method'=>"POST", 'class'=>"form-inline", 'role'=>"form", "id" => "createLoteForm"])); ?>

		<div class="navbar-form navbar-left">
			<div class="form-group">
				<label class="" for="">Obra: </label>
				<?php echo e(Form::select('obra', $obras, old('obra_id'), ['id'=>"inputObra", 'class'=>"form-control", 'required'=>"required"])); ?>

			</div>

			<div class="form-group inputetapa hidden">
				<label class="" for=""> Etapa: </label>
				<?php echo e(Form::select('etapa', $etapas, old('etapa_id'), ['id'=>"inputEtapa", 'class'=>"form-control", 'required'=>"required"])); ?>
			...
			<div class="form-group">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu" id="lotes">
						...
						<li><a href="#"><?php echo e($lote->descricao); ?></a></li>
						<?php endforeach; ?>
					</ul>
				</div>
...
<script>
	$(document).ready(function($) {
		...
		// var urlbase = '<?php echo env("APP_URL"); ?>';
		console.log(urlbase);
		...
		$('#criarlote').click(function(e) {
			...
			$.ajax({
				url: '<?php echo e(route("lotes.create")); ?>',
				type: 'GET',
				dataType: 'html',
				data: {
