<?php echo e(Form::open(['url' => route('lotes.store'), 'class'=>'form-horizontal', 'role'=>"form"])); ?>
	...
	<div class="modal-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="date" name="dataprev_pcp" id="inputDataPCP" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" tabindex="2" required="required">
			</div>
		...
		<!-- HIDDEN IDs -->		
		<input type="hidden" name="obra_id" value="<?php echo e($obra_id); ?>">
		<input type="hidden" name="etapa_id" value="<?php echo e($etapa_id); ?>">
		<input type="hidden" name="grouped" value="<?php echo e($grouped); ?>">
		
		<?php foreach($handles_ids as $handle_id): ?>				
		<input type="hidden" name="handles_ids[]" id="inputHandleIds" class="form-control" value="<?php echo e($handle_id); ?>">
		<?php endforeach; ?>		
